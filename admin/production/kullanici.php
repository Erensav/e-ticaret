              ...
              <tbody>
                ...
                while ($kullanicicek = $kullanicisor->fetch(PDO::FETCH_ASSOC)) { ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <center><a href="../production/kullanici.php?kullanici_id=<?php echo $kullanicicek['kullanici_id']; ?>&kullanicisil=ok" onclick="return confirm('Bu kullanıcıyı silmek istediğinizden emin misiniz?')"><button class="btn btn-danger btn-xs">Sil</button></a></center>
                    </td>
                  </tr>
