<?php include "header.php"; ?>
    <div class="container-fluid text-center mt-5 ">
        <div class="row align-items-start">
            <div class="col-4">
                <ul class="list-group ">
                    ...
                    <button><a style="text-decoration: none;" href="misyon.php">
                            <li class="list-group-item active"><?php echo $ayarcek1["misyon_baslik"] ?></li>
                        </a></button>
            ...
            <div class="col-8">
                <H2><strong><?php echo $ayarcek1["misyon_baslik"] ?></strong></H2>
                <p>
                    <?php echo $ayarcek1["hakkimizda_misyon"] ?>
                </p>
